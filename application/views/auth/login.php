...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <meta name="keywords" content="admin template, Vuexy admin template, dashboard template, flat admin template, responsive admin template, web <?php echo base_url() ?>">
  ...
  <body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
          ...
          <div class="auth-wrapper auth-cover">
            <div class="auth-inner row m-0">
              ...
              <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?php echo base_url() ?>app-assets/images/pages/login-v2.svg" alt="Login V2"/></div>
              </div>
              <!-- /Left Text-->
              <!-- Login-->
                  ...
                  <form class="auth-login-form mt-2" action="" method="POST">
                    ...
                    <input type="password" class="form-control" id="password" name="password">
                      ...
                      <!-- <div class="d-flex justify-content-between">
                        <label class="control-label">Password</label><small>Forgot Password?</small></a>
                      </div>
                      <div class="input-group input-group-merge form-password-toggle">
                        <input type="password" class="form-control" id="password" name="password"><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                      </div> -->
                    </div>
                    <div class="mb-1">
    ...
    <!-- BEGIN: Theme JS-->
    <script src="<?php echo base_url() ?>app-assets/js/core/<?php echo base_url() ?>-menu.min.js"></script>
    <script src="<?php echo base_url() ?>app-assets/js/core/<?php echo base_url() ?>.min.js"></script>
    <!-- END: Theme JS-->
